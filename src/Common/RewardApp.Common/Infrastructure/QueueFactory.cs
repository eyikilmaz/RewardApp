...
namespace RewardApp.Common.Infrastructure;
...
public static class QueueFactory
{
    ...
    {
        var factory = new ConnectionFactory() { HostName = AppConstant.RabbitMQHost };
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer,
                                                      string exchangeName,
                                                      string exchangeType = AppConstant.DefaultExchangeType)
    {

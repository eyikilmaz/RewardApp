...
public class RewardUserRepository : GenericRepository<RewardUser>, IRewardUserRepository
{
    public RewardUserRepository(RewardAppContext dbContext) : base(dbContext)
    {
    }
}
